  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        hint: 'Use "cp" (copy) with source and destination',
      ...
      },
      {
        ...
        hint: 'Use "mv" (move) with source and destination',
      ...
      },
      {
        ...
        hint: 'Use "rm -r" for directories (recursive)',
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        hint: 'Use "grep" to search for patterns',
      ...
      },
      {
        ...
        hint: 'Use "wc" (word count) with the -l flag',
      ...
      },
      {
        ...
        hint: 'Use "find" with the -name option',
    ...
    commands: [
      {
        ...
        hint: 'Use "ls -l" on the specific file',
      ...
      },
      {
        ...
        hint: 'Use "chmod" with numeric (666) or symbolic mode',
      ...
      },
      {
        ...
        hint: 'Use "chmod o-w" to remove write for others',
      ...
      },
      {
        ...
        hint: 'Use "ls -l" to see the owner',
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        hint: 'Use the "free" command with -h flag',
    ...
    commands: [
      {
        ...
        hint: 'Use ls | grep with the pattern',
