...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-background via-background to-muted/20 border-t border-border/50 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-primary/5 to-purple-500/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                <Link
                  href="/feed.xml"
                  className="group p-3 bg-gradient-to-br from-orange-500/10 to-orange-600/10 hover:from-orange-500/20 hover:to-orange-600/20 border border-orange-500/20 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-110"
                  target="_blank"
                >
                ...
                <Link
                  ...
                  className="group p-3 bg-gradient-to-br from-slate-500/10 to-slate-600/10 hover:from-slate-500/20 hover:to-slate-600/20 border border-slate-500/20 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-110"
                  target="_blank"
                >
                ...
                <Link
                  ...
                  className="group p-3 bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 border border-blue-500/20 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-110"
                  target="_blank"
                >
                ...
                <Link
                  ...
                  className="group p-3 bg-gradient-to-br from-gray-500/10 to-gray-600/10 hover:from-gray-500/20 hover:to-gray-600/20 border border-gray-500/20 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-110"
                  target="_blank"
                >
                ...
                <Link
                  ...
                  className="group p-3 bg-gradient-to-br from-pink-500/10 to-pink-600/10 hover:from-pink-500/20 hover:to-pink-600/20 border border-pink-500/20 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-110"
                  target="_blank"
                >
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent flex items-center gap-2">
          ...
          <div className="space-y-6">
            ...
            {/* Newsletter Signup */}
            <div className="p-6 bg-gradient-to-br from-primary/5 to-purple-500/5 border border-primary/20 rounded-2xl shadow-lg">
              ...
              >
                ...
                <button
                  type="submit"
                  name="subscribe"
                  className="group inline-flex items-center justify-center w-full px-4 py-3 bg-gradient-to-r from-primary to-purple-600 text-white rounded-xl text-sm font-bold hover:from-primary/90 hover:to-purple-600/90 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
                  Subscribe Now
