...
const games: Game[] = [
  {
    ...
    description:
      'Learn deployment strategies like Blue-Green, Canary, Rolling Updates, Recreate, and Feature Toggles. Visualize how each strategy handles traffic routing, downtime, and rollbacks in real-time.',
    iconName: 'Rocket',
    badgeText: 'New',
